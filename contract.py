...
class Ui_contract(object):
    ...
    def setupUi(self, contract):
        ...
        self.gridLayout.addWidget(self.del_contract_btn, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.add_contract_btn, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.red_contract_btn, 1, 0, 1, 1)
    ...
    def retranslateUi(self, contract):
        ...
        self.add_contract_btn.setText(_translate("contract", "Добавить новый"))
